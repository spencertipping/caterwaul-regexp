...
}),K):K,W=E.atom==="word"?G(D(t(" ")),u):u,J=F(A(W,G(T,s,Y,O,H,I,Z,N,aa,P,V,S,L,R,Q)),function(ab){return ab[1]});return(J)}).call(this);return((function(s){return(s?s.v[0]:(function(){throw new Error(("caterwaul.regexp(): failed to parse "+(g.toString())+""))
