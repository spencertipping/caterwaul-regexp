...
},is_repetition:function(){return/^[\+\*\{]\??$|^\?$/.test(this.data)},repeated_child:function(){return/^\{/.test(this.data)?this[2]:this[0]},is_character_class:function(){return/^\[/.test(this.data)
...
},s=G(F(A(B,s),function(H){return C(",",H[0],H[1])}),B);return G(F(A(s,t("|"),x),function(H){return C("|",H[0],H[2])}),s)}).call(this),B=(function(){var K=F(t("*"),C),M=F(t("+"),C),J=F(t("?"),C),I=G(F(A(t("{"),j,t("}")),function(N){return C("{",C(N[1]),C(N[1]))
...
}),s=F(A(h("(?!"),x,h(")")),function(ab){return C("(?!",ab[1])}),Y=F(A(h("(?:"),x,h(")")),function(ab){return C("(?:",ab[1])}),O=F(A(h("("),x,h(")")),function(ab){return(function(ac){return k(ac,this),ac
}).call(this,(C("(",ab[1])))}),U=F(D(v),function(ab){return C(ab.join(""))}),M=F(A(h("(?:"),U,h(")")),function(ab){return C(ab[1])}),X=function(ab){return X(ab)},X=(function(){var ab=G(F(A(w(1),t("-"),w(1)),function(ac){return C("-",C(ac[0]),C(ac[2]))
...
}),I=F(A(h("["),X,h("]")),function(ab){return C("[",ab[1])}),Z=F(t("^$"),C),N=F(A(t("\\"),t("BbWwSsDdfnrtv0*+.?|()[]{}\\$^")),function(ab){return C(ab.join(""))}),aa=F(h("\\/"),function(ab){return C("/")
...
}).call(this,(F(A(t("\\"),z,z),function(ad){return +(""+(ad[1])+""+(ad[2])+"")})(ab)))}).call(this)},R=F(t("."),C),K=F(m(1,t(")|+*?{")),C),Q=E.atom==="word"?G(F(D(v),function(ab){return C(ab.join(""))
}),K):K,W=E.atom==="word"?G(D(t(" ")),u):u,J=F(A(W,G(T,s,Y,O,H,I,Z,N,aa,P,V,S,L,R,Q,K)),function(ab){return ab[1]});return J}).call(this);return(function(s){return s?s.v[0]:(function(){throw new Error(("caterwaul.regexp(): failed to parse "+(g.toString())+""))
}).call(this)}).call(this,(A(x,o)({i:0})))}).call(this)};return a.regexp=function(g,f){return a.regexp.parse.apply(this,arguments)},a.regexp.syntax=a.syntax_subclass(b,e),a.regexp.parse=d,a.regexp.compile=c
}).call(this)});